                    ...
                    <div class="row">
                        <div class="col-12">
                            <p class="samuraimart-product-label mt-2">
                                ...
                                <div class="customer-review" style="margin-top: -0.5rem;">
                                    <div class="samuraimart-star-rating" data-rate={{ round($recommend_product->reviews->avg('score') * 2) /2 }}></div>
                                    <div class="samuraimart-rating">{{ number_format(round($recommend_product->reviews->avg('score'), 1), 1) }}</div>
                                </div>
                    ...
                    <div class="col-12">
                        <p class="samuraimart-product-label mt-2">
                            ...
                            <div class="customer-review" style="margin-top: -0.5rem;">
                                ...
                                <div class="samuraimart-rating">{{ number_format(round($recently_product->reviews->avg('score'), 1), 1) }}</div>
                            </div>
